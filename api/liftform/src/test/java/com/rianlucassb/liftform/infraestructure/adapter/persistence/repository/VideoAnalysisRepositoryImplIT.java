...
class VideoAnalysisRepositoryImplIT extends AbstractIntegrationTest {
    ...
    void save_persistsVideoAnalysis() {
        ...
        assertThat(saved.getUserId()).isEqualTo(savedUser.id());
        assertThat(saved.getExerciseType()).isEqualTo(ExerciseType.SQUAT);
        assertThat(saved.getVideoS3Key()).isEqualTo("videos/SQUAT/" + savedUser.id() + "/test.mp4");
    }
